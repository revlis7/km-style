...
@land:              #efefef;
@water:             desaturate(#c4dff6, 50%);
@grass:             desaturate(#e6f2c1, 25%);
@beach:             #FFEEC7;
@park:              desaturate(#daf2c1, 25%);
@cemetery:          desaturate(#d6ded2, 25%);
@wooded:            desaturate(#c3d9ad, 25%);
@agriculture:       #F2E8B6;

@building:          #e4e0e0;
@hospital:          desaturate(#e5c6c3, 25%);
@school:            @land * 0.93; // desaturate(# fff5cc, 25%);
@sports:            @land * 0.94; // desaturate(# b8e6b8, 25%);
...
@motorway_line:     desaturate(#e65c5c, 60%);
@motorway_fill:     lighten(@motorway_line, 10%);
@motorway_case:     @motorway_line * 0.9;

@trunk_line:        desaturate(#e68a5c, 60%);
@trunk_fill:        lighten(@trunk_line, 10%);
@trunk_case:        @trunk_line * 0.9;

@primary_line:      desaturate(#ffc859, 60%);
@primary_fill:      lighten(@primary_line, 10%);
@primary_case:      @primary_line * 0.9;

@secondary_line:    desaturate(#ffe873, 60%);
...
@place_halo:        fadeout(#fff, 10%);

@km_pink:           #e1025d; // #ec0356;

@country_text:      @km_pink;
